  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium px-10">
      ...
      <ul className="hidden sm:flex gap-5  text-sm text-gray-700">
        <NavLink
          to={"/"}
          className="flex flex-col items-center gap-1 text-[18px] hover:opacity-80"
        >
          <p>Home</p>
        </NavLink>
        <NavLink
      ...
      <div className="flex items-center gap-6">
        <Input
          type="text"
          placeholder="Do you looking for what"
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 bg-white ">
              ...
              <DropdownMenuGroup>
                ...
                <DropdownMenuItem className="cursor-pointer hover:opacity-90" onClick={() => navigate("/order")}>Cart</DropdownMenuItem>
